...
const TradeStats = ({ tradeStats, setTradeStats, setStockSymbol, setDate }) => {
    ...
    <div className="trade-stats">
      ...
      <div className="card">
        <div className="item item--1">
          ...
          <span className="quantity"> {tradeStats?.open ?? 0} </span>
        ...
        <div className="item item--2">
          ...
          <span className="quantity"> {tradeStats?.high ?? 0} </span>
        ...
        <div className="item item--3">
          ...
          <span className="quantity"> {tradeStats?.low ?? 0} </span>
          <span className="text text--3"> LOW </span>
        </div>
        <div className="item item--4">
          ...
          <span className="quantity"> {tradeStats?.close ?? 0} </span>
          <span className="text text--4"> CLOSE </span>
        </div>
        <div className="item item--5">
          ...
          <span className="quantity"> {tradeStats?.volume ?? 0} </span>
          <span className="text text--5"> VOLUME </span>
        </div>
      </div>
      ...
      <button className="backButton" onClick={handleBackButton}>
        ...
        <span>Get Back To Stock Form</span>
      </button>
    </div>
  );
};
